...
def get_service_charge(order: List[PurchaseItem]):
    ...
    # Calculate service charge as 1% of the order amount for every Rs. 100
    service_charge_percentage = min(order_amount // 100, 20)
    service_charge = (service_charge_percentage / 100) * order_amount
